...
public void actionPerformed(ActionEvent ae) {
    if(ae.getSource()==b0) {
        ...
        if(((t2.getText()).equals(""))) {
            JOptionPane.showMessageDialog(this,"Please enter supplier name !","Warning!!!",JOptionPane.ERROR_MESSAGE);
          ...
          JOptionPane.showMessageDialog(this,"Invalid email id!","Warning!!!",JOptionPane.WARNING_MESSAGE);
            ...
            try {
                ...
                String str1="UPDATE supplier SET sname='"+t2.getText()+"',saddress='"+t3.getText()+"',sphoneno='"+t4.getText()+"',semailid='"+t5.getText()+"' where semailid = '" + t5.getText() + "' or sname='"+t2.getText()+"' ";
